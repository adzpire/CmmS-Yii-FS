...
<div class="checkinout-index">
	...
	<div class="row">
		<div class="col-md-4 text-center">
			...
			<?= Html::a(Html::icon('check'), ['/lt'], ['class' => 'btn btn-lg btn-danger', 'data-pjax' => 0]);?>
		</div>
		<div class="col-md-4 text-center">
			
			<h1>เวลาเซิฟเวอร์: <?= \Yii::$app->formatter->asTime(time(), "short"); ?></h1>
			<?= Html::a(Html::icon('refresh').' '."รีเฟรช", ['checkinout/stafftoday'], ['class' => 'btn btn-lg btn-primary', 'id' => 'refreshButton']);?>
